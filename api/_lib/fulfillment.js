...
function buildEmailText(product, downloadLinks) {
  ...
  return [
    ...
    'Full license: https://promptanatomy.space/terms/#paid-pdf-license',
    '',
...
function buildEmailHtml(product, downloadLinks) {
  ...
  return [
    ...
    '<p style="margin:0 0 12px;font-size:14px;"><strong>Team license.</strong> Use within your own brand and share with your immediate marketing team. Do not redistribute the full PDF as-is. <a href="https://promptanatomy.space/terms/#paid-pdf-license">Full license</a>.</p>',
