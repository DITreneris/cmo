...
const EN_REPLACEMENTS_PREFIX = [
  ...
  [
    ...
    '<img class="hero-sample hero-sample-image" src="../assets/hero/brief-sample-satori.png" width="640" height="640" alt="Luxury leather handbag on light stone with cinematic lighting and clean negative space for a headline." decoding="async">\n                            <pre class="hero-brief-sample">Luxury leather handbag on light stone,\ncinematic lighting, clean negative space for headline,\n1:1, LinkedIn, premium tone.</pre>'
  ],
  [
